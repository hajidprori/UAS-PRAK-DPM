...
const mongoUrl = "mongodb+srv://hajid12:admin12@cluster0.285tckh.mongodb.net/?retryWrites=true&w=majority";
...
app.post("/createschedule", async (req, res) => {
      const { tgl, kategori, jumlah } = req.body;
